...
for subfolder in folders:
    ...
    print app_folder
    trans_intent_result = check_output(["./acid/run_trans_intent_detector.py", "1",app_folder])
    ...
    recv_intent_result = check_output(["./acid/run_recv_intent_detector.py", "1",app_folder])
    ...
    trans_external_storage_result = check_output(["./acid/run_trans_external_storage_detector.py", "1",app_folder])
    ...
    recv_external_storage_result = check_output(["./acid/run_recv_external_storage_detector.py", "1",app_folder])
    ...
    trans_sharedprefs_result = check_output(["./acid/run_trans_sharedprefs_detector.py", "1",app_folder])
    ...
    recv_sharedprefs_result = check_output(["./acid/run_recv_sharedprefs_detector.py", "1",app_folder])
